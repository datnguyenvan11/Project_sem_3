namespace Project_sem_3.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Project_sem_3.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(Project_sem_3.Models.ApplicationDbContext context)
        {
            ...
            //      new Models.Programme() { Id = 1, Name = "Standard", Price = 4, Status = 1 },
            //       new Models.Programme() { Id = 2, Name = "Silver", Price = 6, Status = 1 },
            //     new Models.Programme() { Id = 3, Name = "Gold", Price = 8, Status = 1 },
            //     new Models.Programme() { Id = 4, Name = "Diamond", Price = 10, Status = 1 }
            //     );
        }
    }
}
